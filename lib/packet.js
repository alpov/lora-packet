...
function LoraPacket(packetContents) {
    ...
    this.getCFListFreqChFour = function() {
        if(that._packet.CFList.length === 16) {
            return util.reverse(that._packet.CFList.slice(0, 0 + 3));
        } else {
            return new Buffer(0);
        }
    };
    ...
    this.getCFListFreqChFive = function() {
        if(that._packet.CFList.length === 16) {
            return  util.reverse(that._packet.CFList.slice(3, 3 + 3));
        } else {
            return new Buffer(0);
        }
    };
    ...
    this.getCFListFreqChSix = function() {
        if(that._packet.CFList.length === 16) {
            return  util.reverse(that._packet.CFList.slice(6, 6 + 3));
        } else {
            return new Buffer(0);
        }
    };
    ...
    this.getCFListFreqChSeven = function() {
        if(that._packet.CFList.length === 16) {
            return  util.reverse(that._packet.CFList.slice(9, 9 + 3));
        } else {
            return new Buffer(0);
        }
    };
    ...
    this.getCFListFreqChEight = function() {
        if(that._packet.CFList.length === 16) {
            return  util.reverse(that._packet.CFList.slice(12, 12 + 3));
        } else {
            return new Buffer(0);
        }
    };
    ...
    this.toString = function() {
        ...
        if (that.isJoinRequestMessage()) {
            //msg += "Join Request;";
            msg += asHexString(p.MHDR) + ";";
            msg += asHexString(p.MACPayload) + ";";
            msg += asHexString(p.MIC) + ";";
            msg += asHexString(p.AppEUI) + ";";
            msg += asHexString(p.DevEUI) + ";";
            msg += asHexString(p.DevNonce) + ";";
        } else if (that.isJoinAcceptMessage()) {
            //msg += "Join Accept;";
            msg += asHexString(p.MHDR) + ";";
            msg += asHexString(p.MIC) + ";";
            msg += asHexString(p.AppNonce) + ";";
            msg += asHexString(p.NetID) + ";";
            msg += asHexString(p.DevAddr) + ";";
            msg += asHexString(p.DLSettings) + ";";
            msg += asHexString(p.RxDelay) + ";";
            msg += asHexString(p.CFList) + ";";
            msg += that.getDLSettingsRxOneDRoffset() + ";";
            msg += that.getDLSettingsRxTwoDataRate() + ";";
            msg += that.getRxDelayDel() + ";";
/*
            if(p.CFList.length === 16) {
                msg += asHexString(that.getCFListFreqChFour()) + ";";
                msg += asHexString(that.getCFListFreqChFive()) + ";";
                msg += asHexString(that.getCFListFreqChSix()) + ";";
                msg += asHexString(that.getCFListFreqChSeven()) + ";";
                msg += asHexString(that.getCFListFreqChEight()) + ";";
            }
*/
        } else if (that.isDataMessage()) {
            //msg += "Data;";
            msg += asHexString(p.MHDR) + ";";
            msg += asHexString(p.MIC) + ";";
            msg += asHexString(p.FHDR) + ";";
            msg += asHexString(p.FPort) + ";";
            msg += asHexString(p.FRMPayload) + ";";
            msg += asHexString(p.DevAddr) + ";";
            msg += asHexString(p.FCtrl) + ";"; //TODO as binary?
            msg += asHexString(p.FCnt) + ";";
            msg += asHexString(p.FOpts) + ";";
            msg += that.getMType() + ";";
            msg += that.getDir() + ";";
            msg += that.getFCnt() + ";";
            msg += (that.getFCtrlACK() ? "1" : "0") + ";";
            msg += (that.getFCtrlADR() ? "1" : "0") + ";";
        }
        return msg;
    };
}
